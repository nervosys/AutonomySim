#ifndef common_utils_ColorUtils_hpp
#define common_utils_ColorUtils_hpp
...
class ColorUtils {
  ...
  public:
    ...
    valToRGB(double val0To1, unsigned char &r, unsigned char &g,
             unsigned char &b) { // actual visible spectrum is 375 to 725 but outside of 400-700 things become too black
