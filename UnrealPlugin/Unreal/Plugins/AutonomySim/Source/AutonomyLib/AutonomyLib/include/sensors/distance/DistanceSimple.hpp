...
#ifndef autonomylib_sensors_DistanceSimple_hpp
#define autonomylib_sensors_DistanceSimple_hpp
...
class DistanceSimple : public DistanceBase {
  ...
  public:
    DistanceSimple(const AutonomySimSettings::DistanceSetting &setting = AutonomySimSettings::DistanceSetting())
    ...
    const DistanceSimpleParams &getParams() const { return params_; }
};
