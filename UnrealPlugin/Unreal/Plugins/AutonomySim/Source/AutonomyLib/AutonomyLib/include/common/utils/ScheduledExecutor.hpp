...
class ScheduledExecutor {
  ...
  private:
    ...
    static TTimePoint nanos() { return clock::now().time_since_epoch().count(); }
    ...
    void executorLoop() {
        ...
        while (started_) {
            ...
            // prevent underflow: https://github.com/nervosys/AutonomySim/issues/617
  ...
  public:
    ...
    void setFrameNumber(uint32_t frameNumber) { currentFrameNumber_ = frameNumber; }
