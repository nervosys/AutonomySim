#ifndef autonomylib_vehicles_simpleflight_firmware_PositionController_hpp
#define autonomylib_vehicles_simpleflight_firmware_PositionController_hpp
                           ...
                           public IGoal // for internal child controller
{
  public:
    ...
    virtual void initialize(unsigned int axis, const IGoal *goal, const IStateEstimator *state_estimator) override {
        ...
        pid_.reset(new PidController<float>(clock_, PidConfig<float>(params_->position_pid.p[axis],
    ...
    virtual void update() override {
        ...
        const Axis4r &measured_position_world = Axis4r::xyzToAxis4(state_estimator_->getPosition(), true);
