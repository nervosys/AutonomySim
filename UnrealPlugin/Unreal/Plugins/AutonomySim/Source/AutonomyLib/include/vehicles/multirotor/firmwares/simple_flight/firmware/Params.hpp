#ifndef autonomylib_vehicles_simpleflight_firmware_Params_hpp
#define autonomylib_vehicles_simpleflight_firmware_Params_hpp
...
struct Params {
  public:
    ...
    struct AngleLevelPid {
        ...
        // max_pitch/roll_angle > 5.5 would produce verticle thrust that is not enough to keep vehicle in air at
        // extremities of controls
    ...
    enum class ControllerType { Cascade, Adaptive };
