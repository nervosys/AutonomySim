...
#ifndef autonomylib_vehicles_MultirotorPhysicsBody_hpp
#define autonomylib_vehicles_MultirotorPhysicsBody_hpp
...
class MultirotorPhysicsBody : public PhysicsBody {
  public:
    MultirotorPhysicsBody(MultirotorParams *params, VehicleApiBase *vehicle_api, Kinematics *kinematics,
    ...
    RotorActuator::Output getRotorOutput(uint rotor_index) const { return rotors_.at(rotor_index).getOutput(); }
  ...
  private: // methods
    ...
    static void createRotors(const MultirotorParams &params, vector<RotorActuator> &rotors,
