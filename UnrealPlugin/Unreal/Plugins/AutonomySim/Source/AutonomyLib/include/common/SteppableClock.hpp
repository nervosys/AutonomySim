...
#ifndef autonomylib_common_SteppableClock_hpp
#define autonomylib_common_SteppableClock_hpp
...
class SteppableClock : public ClockBase {
  public:
    ...
    SteppableClock(TTimeDelta step = DefaultStepSize, TTimePoint start = 0) : current_(start), step_(step) {
