...
class VehicleClient:
    ...
    def simSwapTextures(self, tags, tex_id=0, component_id=0, material_id=0):
        ...
        See https://nervosys.github.io/AutonomySim/texture_swapping/ for details
    ...
    def simGetImage(
        ...
        See https://nervosys.github.io/AutonomySim/apis_image/ for details
        ...
        """
        # todo : in future remove below, it's only for compatibility to pre
        # v1.2
    ...
    def simGetImages(self, requests, vehicle_name="", external=False):
        ...
        See https://nervosys.github.io/AutonomySim/apis_image/ for details and examples
        ...
        return [ImageResponse.from_msgpack(
            response_raw) for response_raw in responses_raw]
    ...
    def simGetWorldExtents(self):
        ...
        return [GeoPoint.from_msgpack(response_raw)
    ...
    def simRunConsoleCommand(self, command):
        ...
        Allows the user to create bespoke APIs very easily, by adding a custom event to the level blueprint, and then calling the console command "ce MyEventName [args]". No recompilation of AutonomySim needed!
    ...
    def simGetMeshPositionVertexBuffers(self):
        ...
        See https://nervosys.github.io/AutonomySim/meshes/ for details and how to use this
    ...
    def simSetObjectScale(self, object_name, scale_vector):
        ...
        Args:
            ...
            scale_vector (autonomysim.Vector3r): Desired scale of object
    ...
    def simSpawnObject(
        ...
        Args:
            ...
            pose (autonomysim.Pose): Desired pose of object
            scale (autonomysim.Vector3r): Desired scale of object
    ...
    def simSetSegmentationObjectID(
        ...
        See https://nervosys.github.io/AutonomySim/apis_image/#segmentation for details

        Args:
            mesh_name (str): Name of the mesh to set the ID of (supports regex)
            object_id (int): Object ID to be set, range 0-255

                             RBG values for IDs can be seen at https://nervosys.github.io/AutonomySim/files/configurations/seg_rgbs.txt
    ...
    def simGetSegmentationObjectID(self, mesh_name):
        ...
        Mapping of Object IDs to RGB values can be seen at https://nervosys.github.io/AutonomySim/seg_rgbs.txt
    ...
    def simGetDetections(
        ...
        return [DetectionInfo.from_msgpack(
            response_raw) for response_raw in responses_raw]
    ...
    def getSettingsString(self):
        """
        Fetch the settings text being used by AutonomySim
...
class MultirotorClient(VehicleClient, object):
    ...
    def setAngleLevelControllerGains(
        ...
        - Modifying these gains will also affect the behaviour of moveByVelocityAsync() API.
            This is because the AutonomySim flight controller will track velocity setpoints by converting them to angle set points.
