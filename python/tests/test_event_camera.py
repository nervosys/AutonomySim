import autonomysim
from python.autonomysim.sensors.event_camera import *
...
parser = argparse.ArgumentParser(description="Simulate event data from AutonomySim")
...
class EventCameraGenerator:
    def __init__(self, W, H, save=False, debug=False):
        self.ev_sim = EventCamera(W, H)
        self.H = H
        self.W = W
...
if __name__ == "__main__":
    ...
    event_generator = EventCameraGenerator(
