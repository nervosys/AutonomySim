...
from python.autonomysim.utils.io import write_file
...
class OrbitNavigator:
    ...
    def start(self):
        ...
        if not self.takeoff and landed == LandedState.Landed:
            self.takeoff = True
            print("taking off...")
    ...
    def take_snapshot(self):
        ...
        self.client.moveToPositionAsync(
            ...
            10,
            DrivetrainType.MaxDegreeOfFreedom,
            YawMode(False, self.camera_heading),
        ).join()
