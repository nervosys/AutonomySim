...
def main():
    """Use the below in settings.json with blocks environment.
    ...
    car_controls1 = CarControls()
    car_controls2 = CarControls()
    ...
    for idx in range(3):
        ...
        responses2 = client.simGetImages(
            [
                ImageRequest("0", ImageType.Segmentation),  # depth visualization image
                ImageRequest("1", ImageType.Scene, False, False),
            ],
            "Car2",
        )  # scene vision image in uncompressed RGB array
