...
int main() {
    ...
    try {
            ...
            for (const ImageResponse &image_info : response) {
                ...
                if (path != "") {
                    ...
                    if (image_info.pixels_as_float) {
                        ...
                        file.write(reinterpret_cast<const char *>(image_info.image_data_uint8.data()),
        ...
        // << "magnetometer_data.magnetic_field_covariance" << magnetometer_data.magnetic_field_covariance // not
