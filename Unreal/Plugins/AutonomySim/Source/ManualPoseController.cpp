...
AActor *UManualPoseController::getActor() const { return actor_; }
...
void UManualPoseController::updateActorPose(float dt) {
    if (actor_ != nullptr) {
        ...
        UAutonomyBlueprintLib::LogMessageString(
            "UManualPoseController::updateActorPose should not be called when actor is not set", "",
...
void UManualPoseController::removeInputBindings() {
    if (left_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(left_mapping_, left_binding_, actor_);
    if (right_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(right_mapping_, right_binding_, actor_);
    if (forward_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(forward_mapping_, forward_binding_, actor_);
    if (backward_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(backward_mapping_, backward_binding_, actor_);
    if (up_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(up_mapping_, up_binding_, actor_);
    if (down_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(down_mapping_, down_binding_, actor_);
    if (left_yaw_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(left_yaw_mapping_, left_yaw_binding_, actor_);
    if (right_yaw_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(right_yaw_mapping_, right_yaw_binding_, actor_);
    if (left_roll_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(left_roll_mapping_, left_roll_binding_, actor_);
    if (right_roll_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(right_roll_mapping_, right_roll_binding_, actor_);
    if (up_pitch_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(up_pitch_mapping_, up_pitch_binding_, actor_);
    if (down_pitch_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(down_pitch_mapping_, down_pitch_binding_, actor_);
    if (inc_speed_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(inc_speed_mapping_, inc_speed_binding_, actor_);
    if (dec_speed_binding_)
        UAutonomyBlueprintLib::RemoveAxisBinding(dec_speed_mapping_, dec_speed_binding_, actor_);

    clearBindings();
}

void UManualPoseController::setupInputBindings() {
    UAutonomyBlueprintLib::EnableInput(actor_);
...
void UManualPoseController::inputManualLeft(float val) { inpute_negative_.Y = val; }
void UManualPoseController::inputManualRight(float val) { input_positive_.Y = val; }
void UManualPoseController::inputManualForward(float val) { input_positive_.X = val; }
void UManualPoseController::inputManualBackward(float val) { inpute_negative_.X = val; }
void UManualPoseController::inputManualMoveUp(float val) { input_positive_.Z = val; }
void UManualPoseController::inputManualDown(float val) { inpute_negative_.Z = val; }
