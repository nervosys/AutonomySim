// AutonomySim Weather API library
...
class AutonomySim_API UWeatherLib : public UBlueprintFunctionLibrary {
    ...
    static const TCHAR *getWeatherParamsObjectPath() {
        return TEXT("/AutonomySim/Weather/WeatherFX/WeatherGlobalParams");
    }
    static const FSoftClassPath getWeatherMenuObjectPath() {
        return FSoftClassPath(TEXT("AActor'/AutonomySim/Weather/UI/MenuActor.MenuActor_C'"));
    }

    static const FSoftClassPath getWeatherActorPath() {
        return FSoftClassPath(TEXT("AActor'/AutonomySim/Weather/WeatherFX/WeatherActor.WeatherActor_C'"));
    }

    static const FSoftClassPath getWeatherMenuWidgetClass() {
        return FSoftClassPath(TEXT("UUserWidget'/AutonomySim/HUDAssets/OptionsMenu.OptionsMenu_C'"));
    }
    // menu class name for finding and closing it
    static const FString getWeatherMenuClassName() { return TEXT("OptionsMenu_C"); }
