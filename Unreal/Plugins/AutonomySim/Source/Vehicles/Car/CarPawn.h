...
class ACarPawn : public AWheeledVehiclePawn {
  ...
  public:
    ...
    const nervosys::autonomylib::CarApiBase::CarControls &getKeyBoardControls() const { return keyboard_controls_; }
  ...
  private:
    ...
    nervosys::autonomylib::CarApiBase::CarControls keyboard_controls_;
