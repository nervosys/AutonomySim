...
template <typename T> inline T wrap_to_pi(T radians) {
...
template <typename T> inline void wrap_to_pi_inplace(T &a) { a = wrap_to_pi(a); }

template <class T> inline T angular_dist(T from, T to) {
