...
while True:
    ...
    if (rawImage == None):
        print("Camera is not returning image, please check AutonomySim for error messages")
        sys.exit(0)
    else:
        png = cv2.imdecode(AutonomySim.string_to_uint8_array(rawImage), cv2.IMREAD_UNCHANGED)
