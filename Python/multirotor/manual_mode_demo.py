...
client.moveByRC(rcdata = AutonomySim.RCData(pitch = 0.0, throttle = 1.0, is_initialized = True, is_valid = True))

AutonomySim.wait_key('Set Yaw and pitch to 0.5')

client.moveByRC(rcdata = AutonomySim.RCData(roll = 0.5, throttle = 1.0, yaw = 0.5, is_initialized = True, is_valid = True))
