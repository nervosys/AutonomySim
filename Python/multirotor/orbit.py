...
class OrbitNavigator:
    ...
    def start(self):
        ...
        if not self.takeoff and landed == autonomysim.LandedState.Landed:
            ...
            print(
                "already flying so we will orbit at current altitude {}".format(
                    start.z_val
                )
            )
        ...
        while count < self.iterations:
            ...
            self.client.moveByVelocityZAsync(
                ...
                z,
                1,
                autonomysim.DrivetrainType.MaxDegreeOfFreedom,
                autonomysim.YawMode(False, camera_heading),
            )
    ...
    def track_orbits(self, angle):
        ...
        if (
            self.quarter
            and self.previous_diff is not None
    ...
    def take_snapshot(self):
        ...
        self.client.moveToPositionAsync(
            ...
            10,
            autonomysim.DrivetrainType.MaxDegreeOfFreedom,
            autonomysim.YawMode(False, self.camera_heading),
        ).join()
...
if __name__ == "__main__":
    ...
    arg_parser.add_argument(
        "--radius", type=float, help="radius of the orbit", default=10
    )
    arg_parser.add_argument(
        "--altitude",
        type=float,
