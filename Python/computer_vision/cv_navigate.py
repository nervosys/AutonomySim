...
def moveUAV(client,pos,yaw):
    client.simSetVehiclePose(AutonomySim.Pose(AutonomySim.Vector3r(pos[0], pos[1], pos[2]), AutonomySim.to_quaternion(0, 0, yaw)), True) 
...
for z in range(10000): # do few times
    ...
    if (target_dist < 1):
        ...
        AutonomySim.wait_key('Press any key to continue')
        break
