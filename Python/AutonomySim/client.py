...
#basic flight control
    ...
    def confirmConnection(self):
        ...
        if server_ver < server_min_ver:
            ...
            print("AutonomySim server is of older version and not supported by this client. Please upgrade!")
        elif client_ver < client_min_ver:
            print(ver_info, file=sys.stderr)
            print("AutonomySim client is of older version and not supported by this server. Please upgrade!")
        else:
            print(ver_info)
        print('')
    ...
    def simSwapTextures(self, tags, tex_id = 0, component_id = 0, material_id = 0):
        ...
        See https://microsoft.github.io/AutonomySim/retexturing/ for details
...
#image_type uses one of the ImageType members
    def simGetImage(self, camera_name, image_type, vehicle_name = '', external = False):
        ...
        See https://microsoft.github.io/AutonomySim/image_apis/ for details
...
#image_type uses one of the ImageType members
    def simGetImages(self, requests, vehicle_name = '', external = False):
        ...
        See https://microsoft.github.io/AutonomySim/image_apis/ for details and examples
...
#gets the static meshes in the unreal scene
    def simGetMeshPositionVertexBuffers(self):
        ...
        See https://microsoft.github.io/AutonomySim/meshes/ for details and how to use this
    ...
    def simSetSegmentationObjectID(self, mesh_name, object_id, is_name_regex = False):
        ...
        See https://microsoft.github.io/AutonomySim/image_apis/#segmentation for details

        Args:
            mesh_name (str): Name of the mesh to set the ID of (supports regex)
            object_id (int): Object ID to be set, range 0-255

                             RBG values for IDs can be seen at https://microsoft.github.io/AutonomySim/seg_rgbs.txt
    ...
    def simGetSegmentationObjectID(self, mesh_name):
        ...
        Mapping of Object IDs to RGB values can be seen at https://microsoft.github.io/AutonomySim/seg_rgbs.txt
