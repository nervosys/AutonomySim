...
#ifndef autonomylib_physics_PhysicsBodyVertex_hpp
#define autonomylib_physics_PhysicsBodyVertex_hpp
...
class PhysicsBodyVertex : public UpdatableObject {
  ...
  public:
    ...
    // getters, setters
    Vector3r getPosition() const { return position_; }
    void setPosition(const Vector3r &position) { position_ = position; }

    Vector3r getNormal() const { return normal_; }
