...
class FrequencyLimiter : public UpdatableObject {
  ...
  public:
    ...
    TTimeDelta getElapsedTotalSec() const { return elapsed_total_sec_; }

    TTimeDelta getElapsedIntervalSec() const { return elapsed_interval_sec_; }

    TTimeDelta getLastElapsedIntervalSec() const { return last_elapsed_interval_sec_; }

    bool isWaitComplete() const { return interval_complete_; }
