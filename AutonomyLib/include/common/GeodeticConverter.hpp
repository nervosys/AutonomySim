...
#ifndef autonomylib_common_GeodeticConverter_hpp
...
class GeodeticConverter {
  public:
    ...
    GeodeticConverter(const GeoPoint &home_geopoint) { setHome(home_geopoint); }
    ...
    void ned2Ecef(const double north, const double east, const float down, double *x, double *y, double *z) {
    ...
    void geodetic2Ned(const double latitude, const double longitude, const float altitude, double *north, double *east,
                      double *down) {
    ...
    void ned2Geodetic(const double north, const double east, const float down, double *latitude, double *longitude,
                      float *altitude) {
    ...
    void enu2Geodetic(const double east, const double north, const float up, double *latitude, double *longitude,
                      float *altitude) {
