#ifndef common_utils_StrictMode_hpp
#define common_utils_StrictMode_hpp

#if defined(_MSC_VER)
//'=': conversion from 'double' to 'float', possible loss of data
#define STRICT_MODE_OFF                                                                                                \
    __pragma(warning(push)) __pragma(warning(                                                                          \
        disable : 4100 4189 4244 4245 4239 4267 4365 4464 4456 4505 4514 4571 4624 4625 4626 4668 4701 4710 4820 4917 5026 5027 5031))
#define STRICT_MODE_ON __pragma(warning(pop))
...
#ifdef __CLANG__
#define STRICT_MODE_OFF                                                                                                \
    _Pragma("clang diagnostic push") _Pragma("clang diagnostic ignored \"-Wctor-dtor-privacy\"")                       \
...
#define STRICT_MODE_ON _Pragma("clang diagnostic pop")

#else
#ifdef __GNUC__
#define STRICT_MODE_OFF                                                                                                \
    _Pragma("GCC diagnostic push") _Pragma("GCC diagnostic ignored \"-Wctor-dtor-privacy\"")                           \
...
#define STRICT_MODE_ON _Pragma("GCC diagnostic pop")
#endif
