...
#ifndef commn_utils_RandomGenerator_hpp
#define commn_utils_RandomGenerator_hpp
...
template <typename TReturn, typename TDistribution, unsigned int Seed = 42> class RandomGenerator {
  ...
  public:
    ...
    template <typename... DistArgs> RandomGenerator(DistArgs... dist_args) : dist_(dist_args...), rand_(Seed) {}
