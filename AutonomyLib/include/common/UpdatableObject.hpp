...
#ifndef autonomylib_common_UpdatableObject_hpp
...
class UpdatableObject {
  public:
    ...
    virtual UpdatableObject *getPhysicsBody() { return nullptr; }

    virtual ClockBase *clock() { return ClockFactory::get(); }
    virtual const ClockBase *clock() const { return ClockFactory::get(); }

    UpdatableObject *getParent() { return parent_; }

    void setParent(UpdatableObject *container) { parent_ = container; }
