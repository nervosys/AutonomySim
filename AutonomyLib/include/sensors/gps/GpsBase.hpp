...
#ifndef autonomylib_sensors_GpsBase_hpp
#define autonomylib_sensors_GpsBase_hpp
  ...
  public:
    ...
    struct GpsPoint {
      public:
        ...
        string to_string() {
            return Utils::stringf("latitude=%f, longitude=%f, altitude=%f, height=%f, health=%d", latitude, longitude,
                                  altitude, height, health);
        }
    };
