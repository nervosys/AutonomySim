...
#ifndef autonomylib_sensors_ImuSimpleParams_hpp
#define autonomylib_sensors_ImuSimpleParams_hpp
...
*/
    ...
    void initializeFromSettings(const AutonomySimSettings::ImuSetting &settings) {
