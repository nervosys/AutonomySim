...
#ifndef autonomylib_sensors_BarometerSimpleParams_hpp
#define autonomylib_sensors_BarometerSimpleParams_hpp
...
struct BarometerSimpleParams {
    ...
    */
    ...
    void initializeFromSettings(const AutonomySimSettings::BarometerSetting &settings) {
