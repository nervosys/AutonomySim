...
#ifndef autonomylib_vehicles_RotorParams_hpp
#define autonomylib_vehicles_RotorParams_hpp
...
enum class RotorTurningDirection : int { RotorTurningDirectionCCW = -1, RotorTurningDirectionCW = 1 };
