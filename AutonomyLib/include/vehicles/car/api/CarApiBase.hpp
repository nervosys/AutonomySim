...
#ifndef autonomylib_vehicles_CarApiBase_hpp
#define autonomylib_vehicles_CarApiBase_hpp
...
class CarApiBase : public VehicleApiBase {
  ...
  public:
    ...
    CarApiBase(const AutonomySimSettings::VehicleSetting *vehicle_setting,
    ...
    void reportState(StateReporter &reporter) override { getSensors().reportState(reporter); }
    ...
    void initialize(const AutonomySimSettings::VehicleSetting *vehicle_setting,
                    std::shared_ptr<SensorFactory> sensor_factory, const Kinematics::State &state,
                    const Environment &environment) {
