...
class ArmDisarmCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("arm|disam - arms or disarms the drone\n"); }
...
class TakeOffCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("takeoff alt - take off to given altitude above ground (in meters).\n"); }
...
class LandCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("land  - auto-land the drone at the current location.\n"); }
...
class RtlCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("rtl  - fly home (return to launch point).\n"); }
...
class MissionCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("mission  - fly preprogrammed mavlink mission.\n"); }
...
class CapabilitiesCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("cap  - fetch and print drone capabilities.\n"); }
...
class BatteryCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("battery  - print next battery message.\n"); }
...
class StatusCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("status  - print next SYS_STATUS message.\n"); }
...
class FakeGpsCommand : public Command {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("fakegps [start|stop] - start stop simple generation of fake GPS input.\n"); }
...
class SendImageCommand : public Command {
  ...
  public:
    ...
    void setLogViewer(std::shared_ptr<MavLinkNode> logViewerProxy) { logViewer = logViewerProxy; }
    virtual bool Parse(const std::vector<std::string> &args);
...
class PlayLogCommand : public Command {
  public:
    ...
    virtual void PrintHelp() { printf("playlog filename - play commands in specified .mavlink file.\n"); }
...
class DumpLogCommandsCommand : public Command {
  public:
    ...
    virtual void PrintHelp() {
        printf(
            "dumplogcommands log_folder - dump commands for .mavlink file found in log folder output in subfolder.\n");
    }
...
class OrbitCommand : public GotoCommand {
  public:
    ...
    virtual void PrintHelp() {
        printf("orbit radius [speed] - orbit the current location & altitude at the given radius (in meters) with "
               "optional speed (default 1m/s).\n");
    }
...
class RotateCommand : public GotoCommand {
  ...
  public:
    ...
    virtual void PrintHelp() { printf("rotate [speed] - rotate the drone at current location with given degrees/s\n"); }
...
class FtpCommand : public Command {
  public:
    ...
    virtual void PrintHelp() {
        printf("ftp command allows you to transfer files to/from the remote drone, if the drone supports the "
...
class WaitForAltitudeCommand : public Command {
  public:
    ...
    virtual void PrintHelp() {
        printf("WaitForAltitudeCommand z dz dvz - wait for drone to get with in dz of the specified local z, and "
               "settle down to given velocity delta (dvz).\n");
    }
