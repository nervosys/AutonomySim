...
class Utils {
  ...
  public:
    ...
    static constexpr float degreesToRadians(float degrees) { return static_cast<float>(M_PIf * degrees / 180.0f); }
    static constexpr double radiansToDegrees(double radians) { return static_cast<double>(radians * 180.0 / M_PIl); }
    static constexpr float radiansToDegrees(float radians) { return static_cast<float>(radians * 180.0f / M_PIf); }
