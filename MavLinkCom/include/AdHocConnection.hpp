...
typedef std::function<void(std::shared_ptr<AdHocConnection> connection, const std::vector<uint8_t> &msg)>
    AdHocMessageHandler;
...
class AdHocConnection : public std::enable_shared_from_this<AdHocConnection> {
  public:
    ...
    static std::shared_ptr<AdHocConnection> connectLocalUdp(const std::string &nodeName, std::string localAddr,
                                                            int localPort);
    ...
    static std::shared_ptr<AdHocConnection> connectRemoteUdp(const std::string &nodeName, std::string localAddr,
