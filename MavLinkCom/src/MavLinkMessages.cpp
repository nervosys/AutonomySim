...
std::string MavLinkLocalPositionNedSystemGlobalOffset::toJSon() {
    std::ostringstream ss;
    ss << "{ \"name\": \"LOCAL_POSITION_NED_SYSTEM_GLOBAL_OFFSET\", \"id\": 89, \"timestamp\":" << timestamp
       << ", \"msg\": {";
    ss << "\"time_boot_ms\":" << this->time_boot_ms;
    ss << ", \"x\":" << float_tostring(this->x);
    ss << ", \"y\":" << float_tostring(this->y);
...
void MavCmdDoVtolTransition::pack() { param1 = State; }
void MavCmdDoVtolTransition::unpack() { State = param1; }
