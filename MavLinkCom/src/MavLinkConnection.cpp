...
std::shared_ptr<MavLinkConnection> MavLinkConnection::connectSerial(const std::string &nodeName,
...
std::shared_ptr<MavLinkConnection> MavLinkConnection::connectLocalUdp(const std::string &nodeName,
                                                                      const std::string &localAddr, int localPort) {
    return MavLinkConnectionImpl::connectLocalUdp(nodeName, localAddr, localPort);
}

std::shared_ptr<MavLinkConnection> MavLinkConnection::connectRemoteUdp(const std::string &nodeName,
...
std::shared_ptr<MavLinkConnection> MavLinkConnection::connectTcp(const std::string &nodeName,
                                                                 const std::string &localAddr,
...
void MavLinkConnection::stopLoggingSendMessage() { pImpl->stopLoggingSendMessage(); }
...
void MavLinkConnection::stopLoggingReceiveMessage() { pImpl->stopLoggingReceiveMessage(); }

void MavLinkConnection::close() { pImpl->close(); }

bool MavLinkConnection::isOpen() { return pImpl->isOpen(); }

void MavLinkConnection::ignoreMessage(uint8_t message_id) { pImpl->ignoreMessage(message_id); }
int MavLinkConnection::prepareForSending(MavLinkMessage &msg) { return pImpl->prepareForSending(msg); }

std::string MavLinkConnection::getName() { return pImpl->getName(); }
int MavLinkConnection::getTargetComponentId() { return pImpl->getTargetComponentId(); }
int MavLinkConnection::getTargetSystemId() { return pImpl->getTargetSystemId(); }

uint8_t MavLinkConnection::getNextSequence() { return pImpl->getNextSequence(); }
void MavLinkConnection::sendMessage(const MavLinkMessageBase &msg) { pImpl->sendMessage(msg); }
void MavLinkConnection::sendMessage(const MavLinkMessage &msg) { pImpl->sendMessage(msg); }

int MavLinkConnection::subscribe(MessageHandler handler) { return pImpl->subscribe(handler); }

void MavLinkConnection::unsubscribe(int id) { pImpl->unsubscribe(id); }

bool MavLinkConnection::isPublishThread() const { return pImpl->isPublishThread(); }
...
void MavLinkConnection::getTelemetry(MavLinkTelemetry &result) { pImpl->getTelemetry(result); }
