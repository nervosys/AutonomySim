...
enum StopBits { StopBits_None = 0, StopBits_10 = (0x0001), StopBits_15 = (0x0002), StopBits_20 = (0x0004) };

enum Handshake { Handshake_None, Handshake_XonXoff, Handshake_RequestToSend, Handshake_RequestToSendXonXoff };
...
class SerialPort : public Port {
  ...
  private:
    int setAttributes(int baud_rate, Parity parity, int data_bits, StopBits bits, Handshake hs, int readTimeout,
                      int writeTimeout);
