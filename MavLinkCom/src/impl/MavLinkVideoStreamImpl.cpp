...
void MavLinkVideoClientImpl::handleMessage(std::shared_ptr<MavLinkConnection> connection,
...
void MavLinkVideoServerImpl::handleMessage(std::shared_ptr<MavLinkConnection> connection,
                                           const MavLinkMessage &message) {
    unused(connection);
    switch (message.msgid) {
...
void MavLinkVideoServerImpl::sendFrame(uint8_t data[], uint32_t data_size, uint16_t width, uint16_t height,
