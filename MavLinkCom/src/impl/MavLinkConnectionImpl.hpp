...
class MavLinkConnectionImpl {
  public:
    ...
    std::string acceptTcp(std::shared_ptr<MavLinkConnection> parent, const std::string &nodeName,
    ...
    ~MavLinkConnectionImpl();
    void startListening(std::shared_ptr<MavLinkConnection> parent, const std::string &nodeName,
