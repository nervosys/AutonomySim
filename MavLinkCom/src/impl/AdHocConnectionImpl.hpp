...
class AdHocConnectionImpl {
  public:
    AdHocConnectionImpl();
    static std::shared_ptr<AdHocConnection> connectSerial(const std::string &nodeName, std::string portName,
    ...
    static std::shared_ptr<AdHocConnection> connectTcp(const std::string &nodeName, std::string localAddr,
    ...
    ~AdHocConnectionImpl();
    void startListening(std::shared_ptr<AdHocConnection> parent, const std::string &nodeName,
