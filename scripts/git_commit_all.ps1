...
param(
    [Parameter(Mandatory=$true, HelpMessage='Root directory of Unreal Engine environment git repositories.')]
    [String]
    $RepoRootDir,
    [Parameter(Mandatory=$true, HelpMessage='Unreal Engine environment commit message.')]
    [String]
